...
public class SequentialLabeling extends RegionLabeling {
	...
	void applyLabeling() {
		//if (beVerbose) IJ.write("Sequential region labeling - Step 1");
		...
		//if (beVerbose) IJ.write("Sequential region labeling - Step 2");
	...
	//IJ.write("Listing collissions********* " + collissionMap.size());
		for (Collision c: collissionMap.keySet()) {
			//IJ.write("  ---next----" + c.a + "/" + c.b + "=" + c);
		}
	}
